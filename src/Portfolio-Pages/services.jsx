                     ...
                     services.map((
                        ...
                        return (
                           <div className="col-lg-4" key={index}>
                              <div className="bg-white rounded-3 shadow px-4 py-5">
                                 <div className="mb-4">
                     ...
                     pricing.map(({
                        ...
                        return (
                           <div className="col-md-6 col-lg-4" key={index}>
                              <div
                                 className="bg-white rounded-3 position-relative zindex-10 overflow-hidden border border-primary border-opacity-20 shadow py-4 px-5">
                                 <span className="text-primary fw-semibold d-block mb-3">
                                    {planName}
                                 </span>
                                 <h2 className="fw-bold text-dark mb-4" style={{ fontSize: '42px' }}>
                                    {price}
                                    <span className="text-body fs-4 fw-medium">
                                       / project
                                    </span>
                                 </h2>
                                 <p className="text-body pb-3 mb-4 border-bottom" style={{ borderColor: '#F2F2F2', fontSize: '14px' }}>
                                    {description}
                                 </p>
                                 <div className="mb-4">
                                    {
                                       features.map((feature, index) => {
                                         ...
                                         return <p className={ feature.isInclude ? 'text-body mb-3' : 'text-secondary text-decoration-line-through mb-3'} key={index}>
                                             {feature.name}
                                          </p>
                                       })
                                    }
